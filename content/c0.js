/* ========== Chapter 0 – 2025 CPG Updates ========== */
window.CPG_DATA = {
    id: "c0",
    title: "2025 CPG Updates",
    ...
    sections: [
        {
            ...
            summary: `
                <div class="sum-card">
                    ...
                    <ul>
                        ...
                        <li><strong>General Medical expanded and organized:</strong> General Medical is split into separate guidelines (easier to teach and follow).</li>
                        <li><strong>Major update in Toxicology/Poisoning:</strong> New general toxicology guidance plus several specific overdose/poisoning guidelines.</li>
                    </ul>
                    ...
                    <div style="background:#e3f2fd; padding:15px; border-radius:12px; margin-bottom:15px;">
                        <table style="width:100%; border-collapse: collapse;">
                            ...
                            <tr>
                                <td style="padding:8px 0;">Suspected Alcohol Intoxication</td>
                                <td style="padding:8px 0;"><span style="background:#004e92; color:white; padding:2px 10px; border-radius:20px;">NEW</span> full guideline</td>
                            </tr>
                            <tr>
                                <td style="padding:8px 0;">General Toxicology Management</td>
                                <td style="padding:8px 0;"><span style="background:#004e92; color:white; padding:2px 10px; border-radius:20px;">NEW</span> foundation guidance</td>
                            </tr>
                            <tr>
                                <td style="padding:8px 0;">Opioid Overdose</td>
                                <td style="padding:8px 0;"><span style="background:#004e92; color:white; padding:2px 10px; border-radius:20px;">NEW</span> specific guideline</td>
                            </tr>
                            <tr>
                                <td style="padding:8px 0;">Beta‑Blocker Overdose</td>
                                <td style="padding:8px 0;"><span style="background:#004e92; color:white; padding:2px 10px; border-radius:20px;">NEW</span> specific guideline</td>
                            </tr>
                            <tr>
                                <td style="padding:8px 0;">Calcium Channel Blocker Overdose</td>
                                <td style="padding:8px 0;"><span style="background:#004e92; color:white; padding:2px 10px; border-radius:20px;">NEW</span> specific guideline</td>
                            </tr>
                            <tr>
                                <td style="padding:8px 0;">Organophosphate Poisoning</td>
                                <td style="padding:8px 0;"><span style="background:#004e92; color:white; padding:2px 10px; border-radius:20px;">NEW</span> specific guideline</td>
                            </tr>
                            <tr>
                                <td style="padding:8px 0;">Invasive (Mechanical) Ventilation</td>
                                <td style="padding:8px 0;"><span style="background:#004e92; color:white; padding:2px 10px; border-radius:20px;">NEW</span> included in Airway</td>
                            </tr>
                            <tr>
                    ...
                    <ul>
                        <li>Adult and pediatric BLS are clearly separated.</li>
                        <li>Adult and pediatric cardiac arrest guidelines are clearly separated.</li>
                        <li>Newborn (less than 4 weeks) and pre‑term infant resuscitation is included.</li>
                        <li>Starting, stopping, and transferring CPR is included.</li>
                    ...
                    <div style="display:flex; flex-wrap:wrap; gap:8px; margin:10px 0;">
                        ...
                        <span style="background:#e2e3e5; padding:5px 12px; border-radius:20px;">Abnormal Behavior</span>
                        <span style="background:#e2e3e5; padding:5px 12px; border-radius:20px;">Adrenal Insufficiency</span>
                        <span style="background:#e2e3e5; padding:5px 12px; border-radius:20px;">Anaphylaxis</span>
                        <span style="background:#e2e3e5; padding:5px 12px; border-radius:20px;">Altered Mental Status</span>
                        <span style="background:#e2e3e5; padding:5px 12px; border-radius:20px;">Epistaxis</span>
                        <span style="background:#e2e3e5; padding:5px 12px; border-radius:20px;">Fever and Sepsis</span>
                        <span style="background:#e2e3e5; padding:5px 12px; border-radius:20px;">Hypoglycemia</span>
                        <span style="background:#e2e3e5; padding:5px 12px; border-radius:20px;">Hyperglycemia</span>
                        <span style="background:#e2e3e5; padding:5px 12px; border-radius:20px;">Nausea and Vomiting</span>
                        <span style="background:#e2e3e5; padding:5px 12px; border-radius:20px;">Non‑Traumatic Shock</span>
                        <span style="background:#e2e3e5; padding:5px 12px; border-radius:20px;">Pain Management</span>
                        <span style="background:#e2e3e5; padding:5px 12px; border-radius:20px;">Sickle Cell Crisis</span>
                        <span style="background:#004e92; color:white; padding:5px 12px; border-radius:20px;">Suspected Alcohol Intoxication (NEW)</span>
                    </div>
                    ...
                    <ul>
                        ...
                        <li>Beta‑Blocker Overdose</li>
                        <li>Calcium Channel Blocker Overdose</li>
                        <li>Organophosphate Poisoning</li>
                    </ul>
            ...
            critical: []    // no critical scenarios
        }
    ]
};